...
class SupplierForm extends BaseComponent<any, State> {
        ...
        <Modal toggleable={true} title="Pilih Pemasok" footerContent={
          ...
          <div className="form-group">
            <FormGroup label="Code">
              <input placeholder="Kode Pemasok" required className="form-control" onChange={this.handleInputChange} value={this.state.code} name="code" />
            </FormGroup>
          </div>
