...
class TransactionOut extends BaseTransactionPage {
  ...
  submit = (e) => {
    ...
    this.showConfirmation("Lanjutkan Transaksi?").then((ok) => {
      if (!ok) return;
      ...
      <div className="container-fluid section-body">
        ...
        <Modal toggleable={true} title={"Produk tersedia di " + transaction.healthCenterLocation?.name}>
          <table className="table table-striped">
            {tableHeader("No", "Id Stok", "Nama", "Jumlah Masuk", "Digunakan", "Stok", "Unit", "Generik", "Kadaluarsa", "Batch", "Opsi")}
            <tbody>
        ...
        <Card title="Daftar Produk">
          <form onSubmit={this.submit}>
            <table className="table table-striped"  >
              {tableHeader("No", "Id Stok", "Nama", "Stok", "Qty", "Unit", "Generk", "Kadaluarsa", "Batch", "Opsi")}
              <tbody>
