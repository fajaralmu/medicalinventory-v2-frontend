...
export default class DashboardBarChart extends Component<IProps, IState> {
  private middleYAxisValue = 0;
  private bottomYAxisValue = 0;
  private offsetX = 100;
  private offsetY = 50;
  private baseYIndex = 200;
      ...
      <Fragment>
        ...
        >
          <svg
            ...
            version="1.1"
            baseProfile="full"
            width={this.offsetX * 2 + (23) * (props.dataSet.length) + 100}
            height={300}
