...
class FormInputTextEditor extends BaseField<FieldProp, IState> {
      ...
      <div>
        ...
        <div id="toolBar2">
          <i
            ...
            onClick={this.paleteCommand}
            data-command="clean"
            className="palete fas fa-broom"
          />
          ...
          <i
            ...
            onClick={this.paleteCommand}
            data-command="italic"
            className="palete fas fa-italic"
          />
          ...
          <i
            ...
            className="palete fas fa-underline"
          />
          ...
          <i
            ...
            className="palete fas fa-align-left"
          />
          ...
          <i
            ...
            className="palete fas fa-align-center"
          />
          ...
          <i
            ...
            className="palete fas fa-align-right"
          />
          ...
          <i
            ...
            className="palete fas fa-list-ol"
          />
          ...
          <i
            onMouseDown={preventDefault}
            onClick={this.paleteCommand}
            data-command="insertonorderedlist"
            className="palete fas fa-list-ul"
          />
          ...
          <i
            ...
            className="palete fas fa-quote-left"
          />
        ...
        <AnchorWithIcon
          ...
          attributes={{ onMouseDown: (e) => e.preventDefault() }}
          onClick={(e) => this.setEditMode(false)}
          show={this.state.editMode === true}
          label="Hide Html"
        />
        <AnchorWithIcon
          className="btn btn-secondary btn-sm"
          attributes={{ onMouseDown: (e) => e.preventDefault() }}
          onClick={(e) => this.setEditMode(true)}
          show={this.state.editMode === false}
          label="Show Html"
        />
      </div>
    );
